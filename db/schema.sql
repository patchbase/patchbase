...
--
-- Name: runtime_status; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.runtime_status AS ENUM (
    'pending',
    'active',
    'disabled',
    'verification_failed'
...
CREATE TABLE public.runtimes (
    ...
    status public.runtime_status DEFAULT 'pending'::public.runtime_status NOT NULL,
    sdk_version text,
    capabilities text[] DEFAULT '{}'::text[] NOT NULL,
    declared_limits jsonb DEFAULT '{}'::jsonb NOT NULL,
    metadata jsonb DEFAULT '{}'::jsonb NOT NULL,
    description text,
    ...
    CONSTRAINT runtimes_id_prefix_check CHECK ((id ~~ like_escape('rt\_%'::text, '\'::text)))
);
...
--
-- Name: runtimes_capabilities_gin_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX runtimes_capabilities_gin_idx ON public.runtimes USING gin (capabilities);


--
-- Name: runtimes_name_unique_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX runtimes_name_unique_idx ON public.runtimes USING btree (name);


--
-- Name: runtimes_status_active_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: runtimes runtimes_set_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER runtimes_set_updated_at BEFORE UPDATE ON public.runtimes FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
