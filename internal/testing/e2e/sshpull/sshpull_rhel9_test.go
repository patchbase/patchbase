...
// Red Hat UBI 9 variant of TestSSHPullE2E_Debian. See
// sshpull_debian_test.go for the rationale; this test reuses the shared
// e2e_helpers via apitesting.RHEL9E2EExpectation() so the per-distro test
...
func TestSSHPullE2E_RHEL9(t *testing.T) {
